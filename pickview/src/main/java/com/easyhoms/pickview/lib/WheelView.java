...
import com.easyhoms.pickview.R;
import com.easyhoms.pickview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private static final float SCALECONTENT = 0.6F;//非中间文字则用此控制高度，压扁形成3d错觉  压扁
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity){
            ...
            case Gravity.LEFT:
                ...
                break;
            case Gravity.RIGHT:
                drawCenterContentStart = measuredWidth - rect.width()-4;
                break;
        }
    }
    private void measuredOutContentStart(String content) {
        ...
        switch (mGravity){
            ...
            case Gravity.LEFT:
                ...
                break;
            case Gravity.RIGHT:
                drawOutContentStart = measuredWidth - rect.width()-4;
                break;
        }
    }
