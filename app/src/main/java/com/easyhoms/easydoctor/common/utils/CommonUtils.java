...
//	}
     ...
     * 获取返回结果code
     */
    public static int getCode(String jsonContent) {
        try {
            JSONObject object = new JSONObject(jsonContent.toString());
...
//                .showImageOnLoading(defImgId)
    ...
    public static void showToast(int stringId) {
        Toast.makeText(DemoCache.getContext(), stringId, Toast.LENGTH_LONG).show();
    }

    public static void showToast(String stringId) {
        Toast.makeText(DemoCache.getContext(), stringId, Toast.LENGTH_LONG).show();
    }
    ...
    * */
    ...
    public static String toTwoDigits(int a) {
     ...
     * @return
     */
    public static String changeDateForamt(String time, String fromFormat, String toformat) {
    ...
    public static String parseDate(Date date, String fromFormat) {
        SimpleDateFormat format2 = new SimpleDateFormat(fromFormat);
        return format2.format(date);
    }
    ...
    * */
    public static String getGender() {
        if (UserManager.getUser().gender.equals("0")) {
            return "男";
        } else if (UserManager.getUser().gender.equals("1")) {
            return "女";
        }
        return "女";
    }
    ...
    * */
    ...
    /*
    * 值为整数的string型数据相减在转为string 即年龄差
    * */
    public static String getAgeGap(String now, String old) {
        return String.valueOf((Integer.parseInt(now) - Integer.parseInt(old)));
    }

    /*
    * 通过比较数据库的日期和当前日期判断用户有没有设置过生日
    * */

    public static boolean isHaveBirth() {
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");//设置日期格式
        String birth = df.format(new Date());
        if (birth.substring(0, 10).equals(UserManager.getUser().birth.substring(0, 10))) {
            return false;
        } else {
            return true;
        }
    ...
    public static boolean isPassDate(String chooseDate) {
        ...
        if (choose.getTime() > dateNow.getTime()) {
            return true;
        } else return false;
    }
    ...
    public static ArrayList<String> strToArray(String str) {
        ...
        ArrayList<String> res=new Gson().fromJson(str, objectType);
        return res;
    }
