...
public class MyTransforMemberDialog {
    ...
    public MyTransforMemberDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
    ...
    public MyTransforMemberDialog setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
            txt_msg.setText("内容");
        } else {
    ...
    public MyTransforMemberDialog setEdit(boolean isEdit, String hint) {
        showEdit = true;
        this.hint = hint;
        return this;
    }
