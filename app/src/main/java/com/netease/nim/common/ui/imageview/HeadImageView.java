...
public class HeadImageView extends CircleImageView {
    ...
    public static final int DEFAULT_AVATAR_THUMB_SIZE = 16;
    public static final int DEFAULT_AVATAR_NOTIFICATION_ICON_SIZE = 10;
    ...
    private static final DisplayImageOptions createImageOptions() {
      //  int defaultIcon = NimUIKit.getUserInfoProvider().getDefaultIconResId();
        int defaultIcon = R.drawable.doctors_default_head;
