...
import com.netease.nim.recent.viewholder.CommonRecentViewHolder;
import com.netease.nim.recent.viewholder.RecentContactAdapter;
import com.netease.nim.recent.viewholder.RecentViewHolder;
import com.netease.nim.recent.viewholder.TeamRecentViewHolder;
...
public class RecentContactsFragment extends TFragment implements TAdapterDelegate {
    ...
    private void showLongClickMenu(final RecentContact recent) {
        ...
        String title = getString(R.string.exit_app);
