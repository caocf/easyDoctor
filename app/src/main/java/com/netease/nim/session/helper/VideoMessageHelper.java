...
public class VideoMessageHelper {
    ...
    public void showVideoSource(int local, int capture) {
        ...
        dialog.setTitle(activity.getString(R.string.video));
...
//        } catch (ActivityNotFoundException e) {
//            ToastUtils.makeText(activity, R.string.gallery_invalid, ToastUtils.LENGTH_SHORT).show();
//        }
    }
...
//            ToastUtils.makeText(activity, R.string.im_choose_video_file_size_too_large, ToastUtils.LENGTH_SHORT).show();
//            return false;
//        }
//
//        if (!StorageUtil.isInvalidVideoFile(file)) {
//            ToastUtils.makeText(activity, R.string.im_choose_video, ToastUtils.LENGTH_SHORT).show();
//            return false;
//        }
        return true;
    }
