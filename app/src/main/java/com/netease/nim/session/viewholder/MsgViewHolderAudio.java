...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    protected void onItemClick() {
        if (audioControl != null) {
            LogUtils.i("attachemnt:"+message.getAttachment().toString());

            if(message.getDirect() == MsgDirectionEnum.In){
                LogUtils.i("MsgDirectionEnum.In");
            }else{
                LogUtils.i("MsgDirectionEnum.out");
            }
            if(message.getAttachStatus() != AttachStatusEnum.transferred){
                LogUtils.i("message.getAttachStatus() != AttachStatusEnum.transferred");
            }else{
                LogUtils.i("message.getAttachStatus() == AttachStatusEnum.transferred");
            }
    ...
    private void layoutByDirection() {
        if (isReceivedMessage()) {
            ...
            containerView.setBackgroundResource(R.drawable.nim_shape_message_item_left);
            ...
            containerView.setBackgroundResource(R.drawable.nim_shape_message_item_right);
