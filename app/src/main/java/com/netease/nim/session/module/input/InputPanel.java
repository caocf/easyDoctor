...
public class InputPanel implements IAudioRecordCallback {
    ...
    private void initViews() {
        ...
        message_photo = (ImageView) view.findViewById(R.id.message_photo);
    ...
    private void initInputBarListener() {
        ...
        message_photo.setOnClickListener(clickListener);
    }
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == switchToTextButtonInInputBar) {
                ...
                switchToAudioLayout();
            } else if (v == message_photo) {

                mImageAction = new ImageAction();
                mImageAction.setContainer(container);
    ...
    private void onTextMessageSendButtonPressed() {
        ...
        if (TextUtils.isEmpty(text)) {
            CommonUtils.showToast(R.string.text_empty);
            return;
        }
...
//    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        mImageAction.onActivityResult(requestCode & 0xff, resultCode, data);
    }
}
